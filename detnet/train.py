...
SGD (lr=0.002, momentum=0.9) with warmup + cosine + grad accumulation.
Reuses rfdetr_video's ema/schedule/selection so selection and early
stopping match the other trainers.
"""
    ...
    for epoch in range(cfg.epochs):
        ...
        if (epoch + 1) % cfg.eval_interval == 0:
            ...
            if ema is not None:
                ...
                ema_metrics = metrics
            # SCA-filtered metrics for reporting only; not fed into selection.
            sca_metrics = {}
