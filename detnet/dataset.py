"""DetNet dataset adapter: wraps VideoStenosisDataset and converts targets
from cxcywh-normalised (RF-DETR) to xyxy-pixel with class 1 (torchvision; 0 is background)."""
