...
Mirrors the argparse surface of :mod:`rfdetr_video.sequence_train` for the
    ...
    if cfg.distill_enabled:
        ...
        if cfg.crrcd_enabled:
            ...
            print(
                ...
                f"tau={cfg.crrcd_temperature}, beta={cfg.crrcd_loss_weight}"
            )
    ...
    for epoch in range(cfg.epochs):
        ...
        if (epoch + 1) % cfg.eval_interval == 0:
            ...
            if early_stopper is not None and early_stopper.update(sel_smoothed):
                print(
                    f"  x Early stop - no smoothed-sel improvement for "
...
def parse_args():
    p = argparse.ArgumentParser(
        description=(
            ...
            "Removed flags vs rfdetr_video: --neighborhood-k, "
    ...
    p.add_argument("--checkpoint", type=str,
                   default="rf-detr/runs/dataset2_augs/checkpoint_best_total.pth")
