"""Smoke tests. Model-build tests are gated behind RFDETR_VIDEO_HEAVY=1."""
...
def test_dataset_returns_T_targets():
    pytest.importorskip("rfdetr_video.sequence_dataset")
...
def test_distill_one_step():
    teacher_ckpt = ROOT / "rf-detr/runs" / "rfdetr_large_arcade2x_704_reg" \
...
def test_eval_ablations_main_accepts_run_name():
    src = (ROOT / "scripts" / "eval_video_run.py").read_text()
