"""Test-time evaluation of a Stenosis-DetNet run on dataset2_split (test)
and CADICA (OOD). Mirrors :mod:`_eval_psstt_dataset2` so MICRO-pooled
metrics drop in next to PSSTT / RF-DETR-video numbers."""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("usage: python _eval_detnet_dataset2.py <run_name>")
        sys.exit(1)
    main(sys.argv[1])
